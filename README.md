...
# cs103-S2018-practical2-starter

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the starter for Practical 2 in Computer Science 103. Since
...
the previous laboratory and practical assignments. Please see the course
...
- The `answers.md` file has at least five subsections created with a `##`
  marker.
- The `answers.md` file contains a link to a `png` graphic file.
- The `answers.md` file contains paragraphs with at least three sentences.
- The `answers.md` file contains content that uses the `*` for bold and italics.
